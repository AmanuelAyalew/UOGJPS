...
<body class="hold-transition sidebar-mini">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/vacancy_register" class="nav-link">
                                <i class="fa-solid fa-registered nav-icon"></i>
                                <p>
                                    Vacancy
                                </p>
                            </a>
    ...
    <script src="{{ asset('javascript/toaster.min.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $('.show_block_confirm').click(function(event) {
            var form = $(this).closest("form");
            var name = $(this).data("name");
            event.preventDefault();
            swal({
                    title: `Are you sure you want to ${name.toLowerCase()} this user?`,
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
