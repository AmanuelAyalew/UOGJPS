                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="grandfathername"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Grand Father Name') }}</label>

                                <div class="col-md-6">
                                    <input id="grandfathername" type="text"
                                        class="form-control @error('grandfathername') is-invalid @enderror"
                                        name="grandfathername" value="{{ old('grandfathername') }}" required
                                        autocomplete="grandfathername" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="password" class="col-md-4 col-form-label text-md-end">Google Captcha</label>
